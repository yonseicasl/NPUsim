...
void spatial_arch_t::init(section_config_t m_section_config) {

    /* Initialize Spatial architecture specifications */

    // Initialize the height and width of spatial architecture
    ...
    /* Initialize signals of Spatial architecture */
    ...
    /* Initialize unit cost of spatial architecture */
    ...
    /* Initialize stats of spatial architecture */
...
void spatial_arch_t::data_transfer(scheduler_t *m_scheduler) {
    ...
    if(noc_type == noc_type_t::MESH) {
                    ...
                    for(unsigned i = 0; i < get_number_of_active_pes(); i++) {
                        ...
                        unsigned data_size = (pes[i]->tile_size_lb[data_type_t::WEIGHT] - m_scheduler->num_zeros[data_type_t::WEIGHT])
                                            ...
                                            *row_bit/8 + // Row index
                                             parameters[parameter_type_t::OUTPUT_CHANNEL]/parameters[parameter_type_t::GROUP]
                                            *parameters[parameter_type_t::INPUT_CHANNEL]/parameters[parameter_type_t::GROUP]
                                            *(parameters[parameter_type_t::FILTER_WIDTH]+1)*row_bit/8; // Column pointer
                    ...
                    for(unsigned i = 0; i < get_number_of_active_pes(); i++) {
                        ...
                        unsigned data_size = (pes[i]->tile_size_lb[data_type_t::WEIGHT] - m_scheduler->num_zeros[data_type_t::WEIGHT])
                                            ...
                                            *column_bit/8 + // Column index
                                             parameters[parameter_type_t::OUTPUT_CHANNEL]/parameters[parameter_type_t::GROUP]
                                            *parameters[parameter_type_t::INPUT_CHANNEL]/parameters[parameter_type_t::GROUP]
                                            *(parameters[parameter_type_t::FILTER_HEIGHT]+1)*column_bit/8; // Row pointer
        ...
        std::cerr << "Undefined NoC Topology" << std::endl;
        exit(1);
    }
